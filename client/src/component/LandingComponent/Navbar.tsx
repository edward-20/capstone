      ...
      {matches ? <>
        <section className="flex gap-10">
          ...
          <section className="flex gap-20">
            ...
            <button onClick={() => navigate('/features')} className="navbar-component">Features</button>
            <button onClick={() => navigate('/about')} className="navbar-component">About Us</button>
          </section>
        </section>
          
        {/* the rest */}
        <section className="flex my-auto">
          <Button className="hover:bg-white hover:text-black hover:border hover:border-black button-navbar" onClick={() => navigate('/help')}>Help and Support</Button>
        </section>
      </> :
      <>
        <section className="flex gap-10">
