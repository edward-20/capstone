...
const Home = () => {
  ...
  const mobileScreen = useMediaQuery('(max-width: 810px)');
    ...
    <div className="overflow-x-hidden">
      ...
      <section className="bg-white-200 h-auto w-full flex flex-wrap lg:h-1/2 no-cursor"> 
        ...
        <section className="landing-description w-full lg:w-1/2 lg:h-3/5 p-[50px] flex flex-col text-center sm:text-left">
          ...
          <div className="mt-10">
            Lorem ipsum blablabla you climb trees and become monkey but elephant comes and sends you flying. Go go WMS. Lorem ipsum blablabla you climb trees and become monkey but elephant comes and sends you flying. Go go WMS. Lorem ipsum blablabla you climb trees and become monkey but elephant comes and sends you flying. Go go WMS
          </div>
